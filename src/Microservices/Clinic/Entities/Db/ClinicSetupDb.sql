USE [master]
GO
/****** Object:  Database [Clinic]    Script Date: 17.05.2020 21:38:10 ******/
...
USE [Clinic]
GO
/****** Object:  Table [dbo].[Clinic]    Script Date: 17.05.2020 21:38:10 ******/
SET ANSI_NULLS ON
GO
...
GO
ALTER TABLE [dbo].[Clinic] ADD  CONSTRAINT [DF_Clinic2_IsActive]  DEFAULT ((0)) FOR [IsActive]
GO
USE [master]
GO
