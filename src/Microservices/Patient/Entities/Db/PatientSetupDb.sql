...
CREATE DATABASE [Patient]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Patient', FILENAME = N'/var/opt/mssql/data/Patient.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Patient_log', FILENAME = N'/var/opt/mssql/data/Patient_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [Patient] SET COMPATIBILITY_LEVEL = 140
GO
...
GO
ALTER TABLE [dbo].[Patient] ADD  CONSTRAINT [DF_Patient2_IsActive]  DEFAULT ((0)) FOR [IsActive]
GO
USE [master]
GO
